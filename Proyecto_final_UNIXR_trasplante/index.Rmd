---
title: "Proyecto Final Trasplante UNIXR  Github"
...
<img src="./Data/Icono_R.jpg" width="100" height="100" />    
<img src="./Data/Icono_Unix.jpg" width="100" height="100" /> 
...
Para ver el Markdown del análisis en R hacer clic [aquí](./Scripts/Proyecto_final_trasplante_R.html)  

### **Análisis de datos UNIX**  
Revisar Proyecto_final_trasplante_UNIX.Rmd  
Para ver el Markdown del análisis en UNIX hacer clic [aquí](./Scripts/Proyecto_final_trasplante_UNIX.html)  
...
Para ver el contenido de los archivos de cada carpeta:   
**Carpeta Data**   
Para ver el Data original .xlsx del análisis hacer clic [aquí](./Data/Dataorg_Trasplante_R.xlsx)   
Para ver el Data .txt hacer clic [aquí](./Data/Data_Trasplante.txt)   

**Carpeta Resultados**
Los archivos de Frecuencias virales y citocinas:  
.RData data [aquí](./Resultados/Frecuencia_virus.RData)      
            [aquí](./Resultados/Frecuencia2_virus.RData)   
.RData plot [aquí](./Resultados/graf_pie_frec_virus.RData)      
            [aquí](./Resultados/graf_viol_MCP1_rechazo.RData)   
.txt        [aquí](./Resultados/Frecuencia_virus.txt)        
            [aquí](./Resultados/Frecuencia2_virus.txt)   
plot .png   [aquí](./Resultados/Frecuencia_viral_Rplot.png)      
            [aquí](./Resultados/Concentracion_MCP1_Rplot.png)    
